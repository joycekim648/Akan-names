...
$(document).ready(function(){
 ...
 if(dd > 31 || dd < 1 || mm >12 || mm < 1) {
  alert("Invalid day of birth!");
   ...
   var akanName = "Your Akan name is " + maleNames[0] + ".";
 }
 else if (day === 1 && gender === "male") {
   var akanName = "Your Akan name is " + maleNames[1] + ".";
 }
  else if (day === 2 && gender === "male") {
   var akanName = "Your Akan name is " + maleNames[2] + ".";
 }
  else if (day === 3 && gender === "male") {
  alert("Your Akan name is " + maleNames[3] + ".");
 }
  else if (day === 4 && gender === "male") {
   var akanName = "Your Akan name is " + maleNames[4] + ".";
 }
  else if (day === 5 && gender === "male") {
   var akanName = "Your Akan name is " + maleNames[5] +".";
 }
  else if (day === 6 && gender === "male") {
   var akanName = "Your Akan name is " + maleNames[6] + ".";
 }
  else if (day === 0 && gender === "female") {
   var akanName = "Your Akan name is " + femaleNames[0] + ".";
 }
  else if (day === 1 && gender === "female") {
   var akanName = "Your Akan name is " + femaleNames[1] + ".";
 }
  else if (day === 2 && gender === "female") {
   var akanName =  "Your Akan name is " + femaleNames[2] + ".";
 }
  else if (day === 3 && gender === "female") {
   var akanName ="Your Akan name is " + femaleNames[3] +".";
 }
  else if (day === 4 && gender === "female") {
   var akanName ="Your Akan name is " + femaleNames[4] + ".";
 }
  else if (day === 5 && gender === "female") {
 var akanName = "Your Akan name is " + femaleNames[5] + ".";
 }
  else if (day === 6 && gender === "female") {
   var akanName ="Your Akan name is " + femaleNames[6] + ".";
 }
